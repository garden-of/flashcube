...
export default class CubeNavigationHorizontal extends React.Component {
  constructor(props) {
    ...
    this.pages = this.props.children.map((child, index) => this.props.width * -index);
    this.fullWidth = (this.props.children.length - 1) * this.props.width;
  ...
  */
  ...
  _getTransformsFor = i => {
    ...
    let opacity = scrollX.interpolate({
      ...
      outputRange: padOutput([0.0, 1, 1, 1, 0.0]),
      extrapolate: 'clamp'
    });
  ...
  render() {
    ...
    return (
      ...
      >
        <Animated.View
          style={[
            { backgroundColor: Colors.transparent, position: 'absolute', width, height },
            expandStyle
          ]}
        >
