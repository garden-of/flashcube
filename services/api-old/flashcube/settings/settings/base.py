"""
Django settings for flashcube project.
...
SECRET_KEY = 'jdjl$j#bii(dmbxwy^6=@)wi4t15o4)&fe+jliw*kpd*8-lrt0'
...
MIDDLEWARE = [
    'flashcube.middleware.HealthCheckMiddleware',
...
WSGI_APPLICATION = 'flashcube.wsgi.application'
